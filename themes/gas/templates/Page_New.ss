...
<body class="$ClassName $URLSegment">
	...
	<!-- <div data-magellan-expedition="fixed">
	  <dl class="sub-nav">
	    ...
	    <dd data-magellan-arrival="ch2"><a href="#ch2">Chapter 2</a></dd>
	    <dd data-magellan-arrival="ch3"><a href="#ch3">Chapter 3</a></dd>
	    <dd data-magellan-arrival="special"><a href="#special">Special</a></dd>
	  </dl>
	</div> -->
	
	<!-- <div class="hide-for-small desktopmenu">
		<button onClick="toggleLeftNav()" class="togglebtn toggleleft fix-y" data-dy="140">MENU <i class="icon-right-open"></i></button>
		<button onClick="toggleRightNav()" class="togglebtn toggleright fix-y" data-dy="140""><i class="icon-left-open"></i> NEWS</button>
		<button onClick="toggleContact()" class="togglebtn toggleleft togglecontact fix-y" data-dy="103">CONTACT <i class="icon-info-circled"></i></button>
	</div> -->
	
	<div class="off-canvas-wrap">
	  <div class="inner-wrap">
	
	<div class="row hide-for-small minimenu">
		<div class="large-12 columns">
			<div class="minimenu-inner">
				<a href="./"><i class="icon-home"></i>home</a> &nbsp;
				<a href="blog">Blog<i class="icon-right-dir-1"></i></a> &nbsp;
				<a href="specials">Specials<i class="icon-right-dir-1"></i></a> &nbsp;
